...
> **Note:** For a complete step-by-step build guide, see the [LeapGlove Wiki](https://github.com/AmZu1212/LeapGlove/wiki/01_Welcome). Or alternatively, you can scroll down on this page.
